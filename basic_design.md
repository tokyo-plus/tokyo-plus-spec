...
5. データソース障害時は正確な判断を生成・表示せず、本来のアドバイス表示領域にTOKYO+のミニゲームを表示する。
...
| 補助データAPI障害 | 正確な判断を生成・表示しない | 本来のアドバイス表示領域にミニゲームを表示 |
...
データソース障害時は、実際の最新データに基づく判断と誤認されないよう、アドバイスを表示せずミニゲームを表示する。ミニゲームから障害発生中であることを確認できるようにする。
